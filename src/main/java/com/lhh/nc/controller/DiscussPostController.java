...
import static com.lhh.nc.util.CommunityConstant.ENTITY_TYPE_COMMENT;
import static com.lhh.nc.util.CommunityConstant.ENTITY_TYPE_POST;
...
public class DiscussPostController {
    ...
    public String addDiscussPost(String title, String content) {
        ...
        // 报错的情况,将来统一处理.
        return CommunityUtil.getJSONString(0, "发布成功666!");
    }
    @Autowired
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page) {
        ...
        page.setTotalPosts(post.getCommentCount());
